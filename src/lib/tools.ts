...
,      "book of answers for students", "best book of answers 2026", "free random answer generator online"        ],
  ...
  {
    id: "reaction-test",
    name: "Reaction Time Test — Reflex Speed Game",
    description: "Test your reflexes with two game modes: Static Flash and Random Position. Measure reaction time in milliseconds, earn speed ratings, track best and average scores. Free, no signup.",
    category: "media",
    icon: "⚡",
    path: "/tools/reaction-test",
    seoTitle: "Free Reaction Time Test Online — Two Mode Reflex Speed Game 2026",
    seoDescription: "Test your reaction speed with this interactive reflex game. Two modes: Static Flash and Random Position. Click targets at random intervals, measure response in milliseconds, earn speed ratings. Local storage saves your best and average scores. Free, no signup.",
    seoKeywords: [
    ...
    howToUse: [
      ...
      "The area turns red — wait patiently for the green target to appear.",
      "Click the green target as fast as you can to measure your reaction time.",
      "Clicking too early (before green) is invalid — you'll need to restart the round.",
      "Repeat to improve your score and climb the rating tiers.",
      "Use 'Clear All Data' to reset your locally stored scores.",
    ],
    faq: [
      { question: "What is a good reaction time?", answer: "Average human reaction time for visual stimuli is around 250ms. Athletes and gamers often achieve times below 200ms. Elite performers can reach as low as 120-150ms. This test lets you benchmark yourself against these tiers." },
      { question: "What are the two game modes?", answer: "Static Flash: the green target always appears in the center — pure reaction speed. Random Position: the green target appears at random locations on screen, testing both reaction speed and spatial awareness." },
      { question: "How does the anti-cheat work?", answer: "If you click or tap before the green target appears (during the red waiting phase), the round is invalidated. You must wait for the green signal. This ensures accurate reaction time measurement." },
      { question: "Are my scores saved?", answer: "Yes! Your best time, average time, and recent history are saved locally in your browser (localStorage). No data is sent anywhere. You can clear all data anytime using the 'Clear All Data' button." },
      { question: "Can I improve my reaction time?", answer: "Yes. Regular practice, staying focused, getting adequate rest, and engaging in fast-paced activities like video games or sports can help improve reaction times over time." },
    ],
    nameTranslations: {
      es: "Test de Tiempo de Reacción — Juego de Velocidad de Reflejos",
      ar: "اختبار زمن رد الفعل — لعبة سرعة الاستجابة",
    },
    descriptionTranslations: {
      es: "Pon a prueba tus reflejos con dos modos de juego: Destello Estático y Posición Aleatoria. Mide el tiempo de reacción en milisegundos, obtén calificaciones de velocidad y sigue tus mejores y promedios. Gratis, sin registro.",
      ar: "اختبر ردود أفعالك مع وضعي لعب: الوميض الثابت والموقع العشوائي. قس زمن رد الفعل بالمللي ثانية، واحصل على تقييمات السرعة، وتابع أفضل وأوقاتك المتوسطة. مجاني، بدون تسجيل.",
    },
    seoTitleTranslations: {
      es: "Prueba de Tiempo de Reacción Gratis Online — Juego de Reflejos Dos Modos 2026",
      ar: "اختبار زمن رد الفعل مجاني عبر الإنترنت — لعبة سرعة الاستجابة بوضعين 2026",
    },
    seoDescriptionTranslations: {
      es: "Pon a prueba tu velocidad de reacción con este juego interactivo de reflejos. Dos modos: Destello Estático y Posición Aleatoria. Haz clic en objetivos a intervalos aleatorios, mide tu respuesta en ms. Gratis, sin registro.",
      ar: "اختبر سرعة رد فعلك مع لعبة الاستجابة التفاعلية هذه. وضعان: الوميض الثابت والموقع العشوائي. انقر على الأهداف في فترات عشوائية، وقس استجابتك بالمللي ثانية. مجاني، بدون تسجيل.",
    },
    howToUseTranslations: {
      es: [
        "Elige un modo: Destello Estático (objetivo en el centro) o Posición Aleatoria (objetivo móvil).",
        "Haz clic en el área de juego o presiona Espacio/Enter para iniciar.",
        "El área se vuelve roja — espera pacientemente a que aparezca el objetivo verde.",
        "Haz clic en el objetivo verde lo más rápido posible para medir tu tiempo.",
        "Hacer clic demasiado pronto (antes del verde) es inválido — se reinicia la ronda.",
        "Repite para mejorar tu puntuación y subir en los niveles de calificación.",
        "Usa 'Borrar Todos los Datos' para restablecer tus puntuaciones guardadas.",
      ],
      ar: [
        "اختر وضعاً: الوميض الثابت (هدف في المركز) أو الموقع العشوائي (هدف متحرك).",
        "انقر على منطقة اللعب أو اضغط مسافة/Enter للبدء.",
        "تتحول المنطقة إلى اللون الأحمر — انتظر بصبر حتى يظهر الهدف الأخضر.",
        "انقر على الهدف الأخضر بأسرع ما يمكن لقياس زمن رد فعلك.",
        "النقر مبكراً جداً (قبل الأخضر) غير صالح — ستحتاج لإعادة الجولة.",
        "كرر لتحسين نتيجتك والتقدم في مستويات التقييم.",
        "استخدم 'مسح جميع البيانات' لإعادة ضبط نتائجك المحفوظة.",
      ],
    },
    faqTranslations: {
      es: [
        { question: "¿Cuál es un buen tiempo de reacción?", answer: "El tiempo promedio humano para estímulos visuales es de unos 250ms. Atletas y gamers suelen lograr menos de 200ms. Los de élite pueden alcanzar 120-150ms." },
        { question: "¿Cuáles son los dos modos de juego?", answer: "Destello Estático: el objetivo verde siempre aparece en el centro — velocidad de reacción pura. Posición Aleatoria: el objetivo aparece en lugares aleatorios, evaluando velocidad y conciencia espacial." },
        { question: "¿Cómo funciona el sistema anti-trampas?", answer: "Si haces clic antes de que aparezca el objetivo verde (durante la fase roja), la ronda se invalida. Debes esperar la señal verde. Esto garantiza una medición precisa." },
        { question: "¿Se guardan mis puntuaciones?", answer: "¡Sí! Tu mejor tiempo, promedio e historial se guardan localmente en tu navegador (localStorage). No se envían datos a ningún lado. Puedes borrar todo con 'Borrar Todos los Datos'." },
        { question: "¿Puedo mejorar mi tiempo de reacción?", answer: "Sí. La práctica regular, mantenerse enfocado, descansar adecuadamente y actividades como videojuegos o deportes pueden mejorar los tiempos con el tiempo." },
      ],
      ar: [
        { question: "ما هو زمن رد الفعل الجيد؟", answer: "متوسط زمن رد الفعل البشري للمحفزات البصرية حوالي 250 مللي ثانية. يحقق الرياضيون واللاعبون أقل من 200 مللي ثانية. النخبة يمكنهم الوصول إلى 120-150 مللي ثانية." },
        { question: "ما هما وضعا اللعب؟", answer: "الوميض الثابت: يظهر الهدف الأخضر دائماً في المركز — سرعة رد فعل نقية. الموقع العشوائي: يظهر الهدف في مواقع عشوائية، لاختبار السرعة والوعي المكاني." },
        { question: "كيف يعمل نظام منع الغش؟", answer: "إذا نقرت قبل ظهور الهدف الأخضر (أثناء المرحلة الحمراء)، يتم إلغاء الجولة. يجب انتظار الإشارة الخضراء. هذا يضمن قياساً دقيقاً لزمن رد الفعل." },
        { question: "هل تُحفظ نتائجي؟", answer: "نعم! أفضل وقت ومتوسط وتاريخ حديث محفوظة محلياً في متصفحك (localStorage). لا تُرسل أي بيانات لأي جهة. يمكنك مسح جميع البيانات باستخدام زر 'مسح جميع البيانات'." },
        { question: "هل يمكنني تحسين زمن رد فعلي؟", answer: "نعم. الممارسة المنتظمة والتركيز والراحة الكافية وأنشطة مثل ألعاب الفيديو أو الرياضة يمكن أن تساعد في تحسين الأوقات." },
      ],
    },
  },
  {
...
,      { question: "Are all the AI tools listed here free?", answer: "Our AI tools directory includes both free and freemium tools. Each listing indicates whether the tool is free, has a free tier, or requires payment. We regularly update the directory." }     ],
  ...
  },
  {
    ...
    faq: [
      ...
      { question: "How many quotes are available?", answer: "ZenQuotes has thousands of quotes in its database, so you'll rarely see the same one twice." },
    ],
    nameTranslations: { en: "Random Inspirational Quote", es: "Cita Inspiradora Aleatoria", ar: "اقتباس ملهم عشوائي" },
    descriptionTranslations: { en: "Random quotes from famous authors. Free.", es: "Citas aleatorias de autores famosos.", ar: "اقتباسات عشوائية من مؤلفين مشهورين." },
    seoTitleTranslations: { en: "Free Random Inspirational Quote Generator — Famous Quotes 2026", es: "Generador de Citas Aleatorias Gratis 2026", ar: "مولد اقتباسات عشوائية مجاني 2026" },
  ...
  },
  {
    ...
    howToUse: [
      ...
      "Watch the card flip through random meals and land on your pick.",
      "Not interested? Click 'Not for me' to block that food from future spins.",
      "Click 'Copy' to share your meal recommendation with friends.",
      "Manage blocked foods by clicking 'Blocked foods' at the bottom.",
    ],
    faq: [
      { question: "How does the food picker work?", answer: "The food picker randomly selects from a curated database of 60+ authentic Western meals across four categories: Quick & Easy Lunch, Budget-Friendly Meals, Fitness & Healthy, and Comfort Food. Each spin is completely random — like a digital food wheel!" },
      { question: "Can I block foods I don't like?", answer: "Yes! When a food lands on your card, click the 'Not for me' button. It will be excluded from future spins until you unblock it. You can manage all blocked foods by clicking 'Blocked foods' at the bottom." },
      { question: "Are the calorie counts accurate?", answer: "Calories are approximate estimates based on typical serving sizes and standard recipes. Actual calories may vary depending on ingredients, portion sizes, and preparation methods. Use as a general reference only." },
      { question: "Is this food picker free?", answer: "Yes, 100% free. No signup required. No hidden costs. All food selections happen instantly in your browser — no data is sent anywhere." },
      { question: "What cuisines are included?", answer: "This food picker focuses on authentic Western and international cuisine popular in North America and Europe: Italian, American, Mexican, British, Mediterranean, Asian-fusion, and more. All meals are dishes you can find or make in Western countries." },
    ],
    nameTranslations: {
      es: "¿Qué Comer? — Selector Aleatorio de Comida",
      ar: "ماذا آكل؟ — منتقي طعام عشوائي",
    },
    descriptionTranslations: {
      es: "¿No puedes decidir qué comer? ¡Deja que nuestro selector aleatorio decida por ti! Explora almuerzos, cenas, comidas dietéticas y comfort food occidentales. Un clic, calorías, bloquea lo que no te gusta. Gratis.",
      ar: "لا تستطيع أن تقرر ماذا تأكل؟ دع منتقي الطعام العشوائي يقرر! تصفح وجبات غربية: غداء، عشاء، وجبات دايت، وطعام مريح. نقرة واحدة، سعرات حرارية، احظر الأطعمة التي لا تحبها. مجاني.",
    },
    seoTitleTranslations: {
      es: "¿Qué Comer? Selector Aleatorio de Comida Gratis — Generador de Decisiones 2026",
      ar: "ماذا آكل؟ منتقي طعام عشوائي مجاني — مولد قرارات الوجبات 2026",
    },
    seoDescriptionTranslations: {
      es: "¿No puedes decidir qué comer? Gira el selector aleatorio de comida para descubrir platos occidentales: almuerzo rápido, comidas económicas, fitness, comfort food. 60+ comidas con calorías. Bloquea lo que no te gusta.",
      ar: "لا تستطيع أن تقرر ماذا تأكل؟ أدر منتقي الطعام العشوائي لاكتشاف وجبات غربية: غداء سريع، وجبات اقتصادية، لياقة، طعام مريح. أكثر من 60 وجبة مع السعرات. احظر الأطعمة التي لا تحبها.",
    },
    howToUseTranslations: {
      es: [
        "Elige una categoría de comida o déjala en 'Todas' para ver todas las opciones.",
        "Haz clic en el botón '¡Elegir Mi Comida!' para iniciar la animación giratoria.",
        "Mira la tarjeta girar entre comidas aleatorias y aterrizar en tu elección.",
        "¿No te interesa? Haz clic en 'No para mí' para bloquear esa comida.",
        "Haz clic en 'Copiar' para compartir tu recomendación con amigos.",
        "Gestiona las comidas bloqueadas haciendo clic en 'Comidas bloqueadas' abajo.",
      ],
      ar: [
        "اختر فئة طعام أو اتركها على 'الكل' لتصفح جميع الخيارات.",
        "انقر على زر 'اختر وجبتي!' لبدء الرسوم المتحركة الدورانية.",
        "شاهد البطاقة تدور بين وجبات عشوائية وتستقر على اختيارك.",
        "غير مهتم؟ انقر على 'ليس لي' لحظر ذلك الطعام من الدورات المستقبلية.",
        "انقر على 'نسخ' لمشاركة توصيتك مع الأصدقاء.",
        "أدر الأطعمة المحظورة بالنقر على 'الأطعمة المحظورة' في الأسفل.",
      ],
    },
    faqTranslations: {
      es: [
        { question: "¿Cómo funciona el selector de comida?", answer: "El selector elige aleatoriamente de una base de datos de más de 60 comidas occidentales auténticas en cuatro categorías: Almuerzo Rápido, Comidas Económicas, Saludable & Fitness y Comida Reconfortante. ¡Cada giro es completamente aleatorio!" },
        { question: "¿Puedo bloquear comidas que no me gustan?", answer: "¡Sí! Cuando una comida aparezca en tu tarjeta, haz clic en 'No para mí'. Quedará excluida de futuros giros hasta que la desbloquees. Gestiona todas las comidas bloqueadas haciendo clic en 'Comidas bloqueadas'." },
        { question: "¿Son precisos los conteos de calorías?", answer: "Las calorías son estimaciones aproximadas basadas en porciones típicas y recetas estándar. Las calorías reales pueden variar según ingredientes, porciones y métodos de preparación. Úsalo solo como referencia general." },
        { question: "¿Es gratis este selector de comida?", answer: "Sí, 100% gratis. Sin registro. Sin costos ocultos. Todas las selecciones ocurren instantáneamente en tu navegador." },
        { question: "¿Qué cocinas están incluidas?", answer: "Este selector se enfoca en cocina occidental e internacional popular en Norteamérica y Europa: italiana, americana, mexicana, británica, mediterránea, fusión asiática y más." },
      ],
      ar: [
        { question: "كيف يعمل منتقي الطعام؟", answer: "يختار المنتقي عشوائياً من قاعدة بيانات تضم أكثر من 60 وجبة غربية أصلية عبر أربع فئات: غداء سريع وسهل، وجبات اقتصادية، صحي ولياقة، وطعام مريح. كل دورة عشوائية تماماً!" },
        { question: "هل يمكنني حظر الأطعمة التي لا أحبها؟", answer: "نعم! عندما يظهر طعام على بطاقتك، انقر على 'ليس لي'. سيتم استبعاده من الدورات المستقبلية حتى تقوم بإلغاء حظره. أدر جميع الأطعمة المحظورة بالنقر على 'الأطعمة المحظورة'." },
        { question: "هل عدد السعرات الحرارية دقيق؟", answer: "السعرات تقديرات تقريبية بناءً على أحجام الحصص النموذجية والوصفات القياسية. قد تختلف السعرات الفعلية حسب المكونات وأحجام الحصص وطرق التحضير. استخدم كمرجع عام فقط." },
        { question: "هل منتقي الطعام هذا مجاني؟", answer: "نعم، مجاني 100%. بدون تسجيل. بدون تكاليف خفية. تتم جميع الاختيارات فوراً في متصفحك." },
        { question: "ما هي المطابخ المدرجة؟", answer: "يركز منتقي الطعام هذا على المطبخ الغربي والعالمي الشائع في أمريكا الشمالية وأوروبا: إيطالي، أمريكي، مكسيكي، بريطاني، متوسطي، آسيوي مندمج، والمزيد." },
      ],
    },
  },
  {
    ...
    seoTitle: "Free Morse Code Translator — Text to Morse & Morse to Text 2026",
    seoDescription: "Convert text to Morse code and decode Morse back to text instantly. Supports A-Z, 0-9, and punctuation. Listen to Morse code audio playback. Free bidirectional converter, no signup.",
    seoKeywords: [
    ...
    howToUse: [
      ...
      "Separate letters with a single space, and use / for word breaks.",
      "Click the speaker button to hear the Morse code played as audio tones.",
      "Use the Copy buttons to copy either text or Morse code to clipboard.",
      "Click Clear to reset both fields and start fresh.",
      "Expand the reference table at the bottom to see all Morse code mappings.",
    ],
    faq: [
      { question: "What is Morse code?", answer: "Morse code is a method of encoding text characters as standardized sequences of dots (short signals) and dashes (long signals). It was developed in the 1830s for telegraph communication and is still used today in aviation, amateur radio, and assistive technology." },
      { question: "Can this converter handle numbers and symbols?", answer: "Yes! This converter supports the full international Morse code standard: letters A-Z, numbers 0-9, and common punctuation including period, comma, question mark, slash, and more." },
      { question: "How do I use the audio playback?", answer: "Once you have Morse code in the output box, click the speaker (🔈) button. Your browser will play the dots and dashes as audio tones — a short beep for each dot, a longer beep for each dash." },
      { question: "How do I separate words in Morse code?", answer: "Use a forward slash (/) between words. For example: HELLO WORLD becomes .... . .-.. .-.. --- / .-- --- .-. .-.. -.." },
      { question: "Is Morse code still used today?", answer: "Yes! Morse code remains in use for aviation navigation aids (VOR/NDB identifiers), amateur radio enthusiasts, emergency signaling (SOS), and as an accessibility tool for people with certain disabilities." },
    ],
    nameTranslations: {
      es: "Traductor de Código Morse Gratis — Texto a Morse y Morse a Texto",
      ar: "مترجم شفرة مورس مجاني — نص إلى مورس ومورس إلى نص",
    },
    descriptionTranslations: {
      es: "Convierte texto a código Morse y decodifica Morse de vuelta a texto al instante. Compatible con A-Z, 0-9 y puntuación. Incluye reproducción de audio. Conversor bidireccional gratuito.",
      ar: "حول النص إلى شفرة مورس وفك تشفير مورس إلى نص فوراً. يدعم A-Z و0-9 وعلامات الترقيم. يتضمن تشغيل صوتي لشفرة مورس. محول ثنائي الاتجاه مجاني.",
    },
    seoTitleTranslations: {
      es: "Traductor de Código Morse Gratis — Texto a Morse y Morse a Texto 2026",
      ar: "مترجم شفرة مورس مجاني — نص إلى مورس ومورس إلى نص 2026",
    },
    seoDescriptionTranslations: {
      es: "Convierte texto a código Morse y decodifica Morse a texto al instante. Compatible con A-Z, 0-9 y puntuación. Escucha el audio del código Morse. Conversor bidireccional gratuito, sin registro.",
      ar: "حول النص إلى شفرة مورس وفك تشفير مورس إلى نص فوراً. يدعم A-Z و0-9 وعلامات الترقيم. استمع إلى صوت شفرة مورس. محول ثنائي الاتجاه مجاني، بدون تسجيل.",
    },
    howToUseTranslations: {
      es: [
        "Escribe tu mensaje en la caja de Texto — el código Morse aparece al instante.",
        "O pega código Morse (puntos y guiones) en la caja Morse para decodificar.",
        "Usa puntos (.) para señales cortas y guiones (-) para señales largas.",
        "Separa letras con un espacio y usa / para separar palabras.",
        "Haz clic en el altavoz para escuchar el código Morse como tonos de audio.",
        "Usa los botones Copiar para copiar texto o código Morse al portapapeles.",
        "Haz clic en Limpiar para reiniciar ambos campos.",
        "Expande la tabla de referencia abajo para ver todas las correspondencias.",
      ],
      ar: [
        "اكتب رسالتك في صندوق النص — يظهر كود مورس فوراً.",
        "أو الصق كود مورس (نقاط وشرطات) في صندوق مورس لفك التشفير.",
        "استخدم النقاط (.) للإشارات القصيرة والشرطات (-) للإشارات الطويلة.",
        "افصل الحروف بمسافة واحدة، واستخدم / لفصل الكلمات.",
        "انقر على زر السماعة لسماع كود مورس كنغمات صوتية.",
        "استخدم أزرار النسخ لنسخ النص أو كود مورس إلى الحافظة.",
        "انقر على مسح لإعادة ضبط كلا الحقلين.",
        "وسّع جدول المرجع في الأسفل لرؤية جميع تطابقات مورس.",
      ],
    },
    faqTranslations: {
      es: [
        { question: "¿Qué es el código Morse?", answer: "El código Morse es un método de codificación de caracteres como secuencias de puntos (señales cortas) y rayas (señales largas). Se desarrolló en los años 1830 para comunicación telegráfica y aún se usa en aviación, radioafición y tecnología asistiva." },
        { question: "¿Puede este convertidor manejar números y símbolos?", answer: "¡Sí! Soporta el estándar internacional completo: letras A-Z, números 0-9 y puntuación común como punto, coma, signo de interrogación y más." },
        { question: "¿Cómo uso la reproducción de audio?", answer: "Cuando tengas código Morse en la caja de salida, haz clic en el altavoz (🔈). Tu navegador reproducirá pitidos cortos para puntos y largos para rayas." },
        { question: "¿Cómo separo palabras en código Morse?", answer: "Usa una barra diagonal (/) entre palabras. Por ejemplo: HOLA MUNDO se convierte en .... --- .-.. .- / -- ..- -. -.. ---" },
        { question: "¿Se sigue usando el código Morse hoy?", answer: "¡Sí! El Morse sigue usándose en navegación aérea (identificadores VOR/NDB), radioaficionados, señalización de emergencia (SOS) y como herramienta de accesibilidad." },
      ],
      ar: [
        { question: "ما هي شفرة مورس؟", answer: "شفرة مورس هي طريقة لترميز الحروف كتسلسلات من النقاط (إشارات قصيرة) والشرطات (إشارات طويلة). طُورت في ثلاثينيات القرن التاسع عشر للاتصال التلغرافي ولا تزال تستخدم في الطيران والراديو والتكنولوجيا المساعدة." },
        { question: "هل يدعم هذا المحول الأرقام والرموز؟", answer: "نعم! يدعم المعيار الدولي الكامل: الحروف A-Z والأرقام 0-9 وعلامات الترقيم الشائعة مثل النقطة والفاصلة وعلامة الاستفهام والمزيد." },
        { question: "كيف أستخدم تشغيل الصوت؟", answer: "عندما يكون لديك كود مورس في صندوق الإخراج، انقر على أيقونة السماعة (🔈). سيشغل متصفحك نغمات قصيرة للنقاط ونغمات أطول للشرطات." },
        { question: "كيف أفصل الكلمات في شفرة مورس؟", answer: "استخدم شرطة مائلة (/) بين الكلمات. مثلاً: مرحبا يصبح -- .-. .... -... .- (حسب الترميز الصوتي العربي)." },
        { question: "هل لا تزال شفرة مورس مستخدمة اليوم؟", answer: "نعم! لا تزال مورس تستخدم في مساعدات الملاحة الجوية وهواة الراديو وإشارات الطوارئ (SOS) وكأداة مساعدة للأشخاص ذوي الاحتياجات الخاصة." },
      ],
    },
  },
  {
    ...
    seoTitle: "Free Online Scoreboard — Two-Team Score Keeper with Timer 2026",
    seoDescription: "Free two-team scoreboard with custom names, quick +/- buttons, round counter, countdown timer and stopwatch. Perfect for board games, sports, tournaments. Four color themes. Save scores locally. No signup required.",
    seoKeywords: [
    ...
    howToUse: [
      ...
      "Tap 'Set score manually' to enter an exact score number.",
      "Use the round counter to track which round or set you're on.",
      "Choose Stopwatch (count up) or Countdown (set minutes, count down) for timed matches.",
      "Tap 'Swap' to exchange scores between teams — useful between rounds.",
      "Tap 'Reset All' to clear everything and start fresh.",
      "Switch color themes (Classic, Neon, Sports, Dark Mode) from the dropdown.",
      "All data is saved locally in your browser and restored on revisit.",
    ],
    faq: [
      { question: "Can I use this for board games?", answer: "Absolutely! This scoreboard is perfect for board games like Catan, Carcassonne, Ticket to Ride, Scrabble, and any game where you need to track points for two players or teams." },
      { question: "Does it save my scores?", answer: "Yes. Team names, scores, round number, and your theme preference are automatically saved to your browser's local storage. They'll be restored when you come back." },
      { question: "Can I use this on my phone?", answer: "Yes! The scoreboard is fully responsive and optimized for mobile touch. Buttons are large enough to tap comfortably, and the score display is big and easy to read." },
      { question: "What's the timer for?", answer: "The built-in timer offers two modes: Stopwatch (counts up for tracking match duration) and Countdown (set a time limit and it counts down to zero). Perfect for timed rounds or speed games." },
      { question: "Is this completely free?", answer: "Yes, 100% free. No signup, no ads blocking functionality, no premium features. Everything works right in your browser." },
    ],
    nameTranslations: {
      es: "Marcador Gratis — Contador de Puntos para Dos Equipos con Temporizador",
      ar: "لوحة نتائج مجانية — عداد نقاط لفريقين مع مؤقت",
    },
    descriptionTranslations: {
      es: "Lleva la puntuación de dos equipos con este marcador online gratuito. Nombres personalizados, botones rápidos +/-, contador de rondas, temporizador y cronómetro. Perfecto para juegos de mesa, deportes y torneos.",
      ar: "تتبع نقاط فريقين مع لوحة النتائج المجانية هذه. أسماء فرق مخصصة، أزرار +/− سريعة، عداد جولات، مؤقت تنازلي وساعة توقيت. مثالي لألعاب الطاولة والرياضة والبطولات.",
    },
    seoTitleTranslations: {
      es: "Marcador Online Gratis — Contador de Puntos para Dos Equipos con Temporizador 2026",
      ar: "لوحة نتائج مجانية عبر الإنترنت — عداد نقاط لفريقين مع مؤقت 2026",
    },
    seoDescriptionTranslations: {
      es: "Marcador gratuito para dos equipos con nombres personalizados, botones +/− rápidos, contador de rondas, temporizador y cronómetro. Perfecto para juegos de mesa, deportes y torneos. Guarda puntuaciones localmente.",
      ar: "لوحة نتائج مجانية لفريقين مع أسماء مخصصة وأزرار +/− سريعة وعداد جولات ومؤقت تنازلي وساعة توقيت. مثالية لألعاب الطاولة والرياضة والبطولات. تحفظ النتائج محلياً.",
    },
    howToUseTranslations: {
      es: [
        "Toca los nombres de los equipos para personalizarlos.",
        "Usa los botones +1, +5, +10 para sumar puntos rápido, o -1, -5, -10 para restar.",
        "Toca 'Establecer puntuación manual' para ingresar un número exacto.",
        "Usa el contador de rondas para seguir la ronda o set actual.",
        "Elige Cronómetro (cuenta ascendente) o Cuenta regresiva (configura minutos).",
        "Toca 'Intercambiar' para cambiar puntuaciones entre equipos.",
        "Toca 'Restablecer Todo' para borrar todo y empezar de nuevo.",
        "Cambia temas de color (Clásico, Neón, Deportivo, Modo Oscuro).",
        "Todos los datos se guardan localmente en tu navegador.",
      ],
      ar: [
        "انقر على أسماء الفرق لتخصيصها.",
        "استخدم أزرار +1، +5، +10 لإضافة النقاط بسرعة، أو −1، −5، −10 للطرح.",
        "انقر على 'تعيين النتيجة يدوياً' لإدخال رقم دقيق.",
        "استخدم عداد الجولات لتتبع الجولة أو المجموعة الحالية.",
        "اختر ساعة توقيت (عد تصاعدي) أو مؤقت تنازلي (حدد الدقائق).",
        "انقر على 'تبديل' لتبادل النقاط بين الفرق.",
        "انقر على 'إعادة ضبط الكل' لمسح كل شيء والبدء من جديد.",
        "بدّل بين سمات الألوان (كلاسيكي، نيون، رياضي، داكن).",
        "جميع البيانات محفوظة محلياً في متصفحك.",
      ],
    },
    faqTranslations: {
      es: [
        { question: "¿Puedo usar esto para juegos de mesa?", answer: "¡Por supuesto! Este marcador es perfecto para juegos como Catan, Carcassonne, Ticket to Ride, Scrabble y cualquier juego donde necesites seguir puntos de dos jugadores." },
        { question: "¿Guarda mis puntuaciones?", answer: "Sí. Nombres de equipos, puntuaciones, número de ronda y preferencia de tema se guardan automáticamente en el almacenamiento local de tu navegador." },
        { question: "¿Puedo usarlo en mi teléfono?", answer: "¡Sí! El marcador es totalmente responsive y optimizado para pantallas táctiles. Los botones son grandes y la pantalla de puntuación es fácil de leer." },
        { question: "¿Para qué sirve el temporizador?", answer: "El temporizador tiene dos modos: Cronómetro (cuenta hacia arriba) y Cuenta Regresiva (establece un límite de tiempo). Perfecto para rondas cronometradas." },
        { question: "¿Es completamente gratis?", answer: "Sí, 100% gratis. Sin registro, sin anuncios que bloqueen funciones, sin características premium." },
      ],
      ar: [
        { question: "هل يمكنني استخدامها لألعاب الطاولة؟", answer: "بالتأكيد! لوحة النتائج هذه مثالية لألعاب مثل كاتان وكاركاسون وتيكت تو رايد وسكرابل وأي لعبة تحتاج فيها لتتبع النقاط." },
        { question: "هل تحفظ نتائجي؟", answer: "نعم. أسماء الفرق والنقاط ورقم الجولة وتفضيلات السمة تُحفظ تلقائياً في التخزين المحلي لمتصفحك." },
        { question: "هل يمكنني استخدامها على هاتفي؟", answer: "نعم! لوحة النتائج متجاوبة بالكامل ومحسّنة للمس. الأزرار كبيرة بما يكفي للنقر بشكل مريح." },
        { question: "ما فائدة المؤقت؟", answer: "المؤقت له وضعان: ساعة توقيت (عد تصاعدي) ومؤقت تنازلي (حدد وقتاً). مثالي للجولات الموقوتة أو ألعاب السرعة." },
        { question: "هل هي مجانية بالكامل؟", answer: "نعم، مجانية 100%. بدون تسجيل، بدون إعلانات تعيق الوظائف، بدون ميزات مدفوعة." },
      ],
    },
  },
  {
  ...
  // ── 2026-07-07: 3 new tools ──
  {
    id: "jwt-decoder",
    name: "JWT Decoder",
    description: "Decode JWT tokens instantly — inspect header, payload, and signature. See algorithm, issued-at and expiration timestamps in human-readable format. All decoding happens in your browser, your tokens never leave your device.",
    category: "developer",
    icon: "🔐",
    path: "/tools/jwt-decoder",
    seoTitle: "Free JWT Decoder Online - Decode JSON Web Tokens Instantly 2026",
    seoDescription: "Decode JWT tokens online. Inspect header, payload, and signature. See algorithm, timestamps, and claims in a readable format. Free JWT decoder. No data sent to any server.",
    seoKeywords: ["jwt decoder", "decode jwt", "jwt token decoder", "json web token", "jwt.io alternative", "decode jwt online", "jwt header payload", "jwt debugger", "free jwt decoder"],
    relatedTools: ["base64-converter", "hash-generator", "url-encoder"],
    sceneIntro: "You have a JWT token from an API response. It's three base64 strings separated by dots. You need to see what's inside — the algorithm, the claims, the expiration time. Paste it here. The header and payload decode instantly, the timestamps convert to your local timezone, and the token never leaves your browser.",
    howToUse: ["Paste your JWT token into the input field.", "The header and payload are decoded automatically in real time.", "Review the algorithm (alg), token type (typ), and all claims.", "Check the issued-at and expiration timestamps — expired tokens are highlighted in red.", "Copy the decoded payload JSON with one click."],
    faq: [
      { question: "What is a JWT token?", answer: "JWT (JSON Web Token) is a compact, URL-safe way to represent claims between two parties. It consists of three Base64url-encoded parts: header (contains algorithm and token type), payload (contains claims like user ID, expiration, issuer), and signature (cryptographic signature to verify the token hasn't been tampered with)." },
      { question: "Does this tool verify JWT signatures?", answer: "No. This tool decodes and displays the header, payload, and signature for inspection. It does not verify the cryptographic signature — that requires the secret key or public key, which should never be shared with an online tool. For signature verification, use a library in your backend code." },
      { question: "Is my JWT token sent to any server?", answer: "No. All decoding happens locally in your browser using JavaScript. Your token never leaves your device. This is important because JWT tokens often contain sensitive information like user IDs and permissions." },
      { question: "What is the difference between JWT and JWS?", answer: "JWT (JSON Web Token) is the data format. JWS (JSON Web Signature) is the signed version of a JWT. Most tokens you encounter are actually JWS — they include the cryptographic signature as the third part. An unsigned JWT has only two parts separated by a dot." },
      { question: "Why does the timestamp show a date in 1970?", answer: "JWT timestamps (iat, exp, nbf) are Unix timestamps in seconds. If a timestamp is 0 or very small, it corresponds to January 1, 1970 — the Unix epoch. This usually means the claim is missing or was set incorrectly by the token issuer." },
    ],
    nameTranslations: { es: "Decodificador de JWT", ar: "فاك تشفير JWT" },
    descriptionTranslations: { es: "Decodifica tokens JWT al instante — inspecciona header, payload y firma. Ve algoritmo, emisión y expiración en formato legible. Todo en tu navegador.", ar: "فك تشفير رموز JWT فوراً — افحص الترويسة والحمولة والتوقيع. شاهد الخوارزمية وتواريخ الإصدار والانتهاء بتنسيق مقروء. كل شيء في متصفحك." },
    seoTitleTranslations: { es: "Decodificador JWT Gratis Online - Decodifica JSON Web Tokens 2026", ar: "فاك تشفير JWT مجاني عبر الإنترنت - فك تشفير رموز الويب 2026" },
    seoDescriptionTranslations: { es: "Decodifica tokens JWT online. Inspecciona header, payload y firma. Ve algoritmo, marcas de tiempo y claims en formato legible. Decodificador JWT gratuito.", ar: "فك تشفير رموز JWT عبر الإنترنت. افحص الترويسة والحمولة والتوقيع. شاهد الخوارزمية والطوابع الزمنية والمطالبات. فاك تشفير JWT مجاني." },
    howToUseTranslations: {
      es: ["Pega tu token JWT en el campo de entrada.", "El header y payload se decodifican automáticamente.", "Revisa el algoritmo, tipo de token y todos los claims.", "Verifica las marcas de tiempo — tokens expirados se resaltan en rojo.", "Copia el JSON del payload con un clic."],
      ar: ["الصق رمز JWT في حقل الإدخال.", "يتم فك تشفير الترويسة والحمولة تلقائياً.", "راجع الخوارزمية ونوع الرمز وجميع المطالبات.", "تحقق من الطوابع الزمنية — الرموز المنتهية تظهر باللون الأحمر.", "انسخ JSON الحمولة بنقرة واحدة."],
    },
    faqTranslations: {
      es: [
        { question: "¿Qué es un token JWT?", answer: "JWT (JSON Web Token) es un formato compacto para representar claims entre dos partes. Consta de tres partes: header (algoritmo y tipo), payload (claims como ID de usuario, expiración) y firma (para verificar que el token no fue alterado)." },
        { question: "¿Esta herramienta verifica firmas JWT?", answer: "No. Esta herramienta decodifica y muestra el contenido. No verifica la firma criptográfica — eso requiere la clave secreta o pública, que nunca debe compartirse con una herramienta online." },
        { question: "¿Mi token JWT se envía a algún servidor?", answer: "No. Toda la decodificación ocurre en tu navegador. Tu token nunca sale de tu dispositivo." },
        { question: "¿Cuál es la diferencia entre JWT y JWS?", answer: "JWT es el formato de datos. JWS es la versión firmada del JWT. La mayoría de tokens que encuentras son JWS — incluyen la firma criptográfica como tercera parte." },
        { question: "¿Por qué la marca de tiempo muestra 1970?", answer: "Las marcas de tiempo JWT son timestamps Unix en segundos. Si es 0 o muy pequeño, corresponde al 1 de enero de 1970. Esto suele significar que el claim falta o fue configurado incorrectamente." },
      ],
      ar: [
        { question: "ما هو رمز JWT؟", answer: "JWT هو تنسيق مضغوط وآمن لتمثيل المطالبات بين طرفين. يتكون من ثلاثة أجزاء: الترويسة (الخوارزمية والنوع)، الحمولة (المطالبات)، والتوقيع (للتحقق من عدم التلاعب)." },
        { question: "هل تتحقق هذه الأداة من توقيع JWT؟", answer: "لا. تفك هذه الأداة التشفير وتعرض المحتوى فقط. التحقق من التوقيع يتطلب المفتاح السري أو العام، ويجب ألا يشارك مع أداة عبر الإنترنت." },
        { question: "هل يُرسل رمز JWT إلى أي خادم؟", answer: "لا. كل فك التشفير يتم محلياً في متصفحك. رمزك لا يغادر جهازك أبداً." },
        { question: "ما الفرق بين JWT و JWS؟", answer: "JWT هو تنسيق البيانات. JWS هو النسخة الموقعة من JWT. معظم الرموز هي JWS — تتضمن التوقيع كجزء ثالث." },
        { question: "لماذا يظهر الطابع الزمني تاريخ 1970؟", answer: "الطوابع الزمنية في JWT هي طوابع Unix بالثواني. إذا كانت 0 أو صغيرة جداً، تقابل 1 يناير 1970. هذا يعني عادة أن المطالبة مفقودة." },
      ],
    },
    sceneIntroTranslations: { es: "Tienes un token JWT de una respuesta de API. Son tres strings base64 separadas por puntos. Necesitas ver qué hay dentro — el algoritmo, los claims, la expiración. Pégalo aquí. Header y payload se decodifican al instante, los timestamps se convierten a tu zona horaria, y el token nunca sale de tu navegador.", ar: "لديك رمز JWT من استجابة API. إنه ثلاث سلاسل base64 مفصولة بنقاط. تحتاج لرؤية ما بداخله — الخوارزمية والمطالبات ووقت الانتهاء. الصقه هنا. يتم فك الترويسة والحمولة فوراً، تتحول الطوابع الزمنية إلى توقيتك المحلي، والرمز لا يغادر متصفحك أبداً." },
  },
  {
    id: "cron-parser",
    name: "Cron Expression Parser",
    description: "Parse cron expressions and see when your scheduled jobs will run. Get human-readable descriptions and the next 10 execution times. Supports all 5-field standard cron syntax — no server needed.",
    category: "developer",
    icon: "⏱️",
    path: "/tools/cron-parser",
    seoTitle: "Free Cron Expression Parser Online - See Next Execution Times 2026",
    seoDescription: "Parse cron expressions to see human-readable descriptions and next execution times. Supports 5-field cron syntax. Free online cron parser. No server required.",
    seoKeywords: ["cron parser", "cron expression", "crontab", "cron schedule", "cron to human", "cron calculator", "next cron execution", "cron syntax", "free cron parser"],
    relatedTools: ["unix-timestamp", "hash-generator", "base64-converter"],
    sceneIntro: "You found a cron expression in a server config: `0 2 * * 0`. Does that run at 2 AM every day, or 2 AM only on Sundays? You could check the documentation. Or paste it here and see 'At 02:00 AM, every Sunday' plus the next 10 execution times.",
    howToUse: ["Enter a cron expression in the 5-field format: minute hour day-of-month month day-of-week.", "The human-readable description appears instantly.", "See the next 10 execution times calculated from the current time.", "Invalid expressions show a clear error message explaining what's wrong."],
    faq: [
      { question: "What is a cron expression?", answer: "A cron expression is a string of 5 fields that defines a schedule for recurring tasks. Each field represents: minute (0-59), hour (0-23), day of month (1-31), month (1-12), and day of week (0-7, where 0 and 7 are Sunday). Special characters like *, /, -, and , allow flexible scheduling." },
      { question: "What does */5 * * * * mean?", answer: "*/5 in the minute field means 'every 5 minutes.' The full expression means: run every 5 minutes, every hour, every day, every month, every day of the week. This is a common schedule for health checks and monitoring scripts." },
      { question: "What does 0 9 * * 1-5 mean?", answer: "At 09:00 AM, Monday through Friday. The 1-5 in the day-of-week field means Monday (1) through Friday (5). This is a common schedule for weekday business-hour tasks like sending daily reports." },
      { question: "Does this support @yearly, @monthly, and other shortcuts?", answer: "This tool focuses on the 5-field cron syntax which is the most portable across systems. Shortcuts like @daily, @hourly, and @reboot are specific to certain cron implementations. You can express the same schedules with the 5-field format: @daily = 0 0 * * *." },
      { question: "Is my cron expression sent to a server?", answer: "No. All parsing and execution time calculation happens in your browser. Your cron expressions never leave your device." },
    ],
    nameTranslations: { es: "Analizador de Expresiones Cron", ar: "محلل تعبيرات Cron" },
    descriptionTranslations: { es: "Analiza expresiones cron y ve cuándo se ejecutarán tus tareas programadas. Descripciones legibles y próximas 10 ejecuciones. Soporta sintaxis cron de 5 campos.", ar: "حلل تعبيرات cron وشاهد متى ستعمل مهامك المجدولة. أوصاف مقروءة وأوقات التنفيذ العشرة القادمة. يدعم صيغة cron ذات 5 حقول." },
    seoTitleTranslations: { es: "Analizador Cron Gratis Online - Ve Tiempos de Ejecución 2026", ar: "محلل Cron مجاني عبر الإنترنت - شاهد أوقات التنفيذ القادمة 2026" },
    seoDescriptionTranslations: { es: "Analiza expresiones cron para ver descripciones legibles y próximos tiempos de ejecución. Soporta sintaxis cron de 5 campos. Analizador cron online gratuito.", ar: "حلل تعبيرات cron لرؤية أوصاف مقروءة وأوقات التنفيذ القادمة. يدعم صيغة cron ذات 5 حقول. محلل cron مجاني عبر الإنترنت." },
    howToUseTranslations: {
      es: ["Ingresa una expresión cron en formato de 5 campos: minuto hora día-del-mes mes día-de-la-semana.", "La descripción legible aparece instantáneamente.", "Ve las próximas 10 ejecuciones calculadas desde la hora actual.", "Expresiones inválidas muestran un mensaje de error claro."],
      ar: ["أدخل تعبير cron بتنسيق 5 حقول: دقيقة ساعة يوم-الشهر شهر يوم-الأسبوع.", "يظهر الوصف المقروء فوراً.", "شاهد أوقات التنفيذ العشرة القادمة محسوبة من الوقت الحالي.", "التعبيرات غير الصالحة تظهر رسالة خطأ واضحة."],
    },
    faqTranslations: {
      es: [
        { question: "¿Qué es una expresión cron?", answer: "Una expresión cron es una cadena de 5 campos que define un horario para tareas recurrentes. Cada campo: minuto (0-59), hora (0-23), día del mes (1-31), mes (1-12), día de la semana (0-7, donde 0 y 7 son domingo)." },
        { question: "¿Qué significa */5 * * * *?", answer: "*/5 en el campo de minutos significa 'cada 5 minutos.' La expresión completa: ejecutar cada 5 minutos, cada hora, cada día. Común para health checks." },
        { question: "¿Qué significa 0 9 * * 1-5?", answer: "A las 09:00 AM, de lunes a viernes. 1-5 en día de la semana significa lunes (1) a viernes (5). Común para informes diarios en horario laboral." },
        { question: "¿Soporta atajos como @yearly?", answer: "Esta herramienta se enfoca en la sintaxis de 5 campos, la más portable. Los atajos como @daily son específicos de ciertas implementaciones. Puedes expresar los mismos horarios con 5 campos: @daily = 0 0 * * *." },
        { question: "¿Mi expresión cron se envía a un servidor?", answer: "No. Todo el análisis ocurre en tu navegador. Tus expresiones cron nunca salen de tu dispositivo." },
      ],
      ar: [
        { question: "ما هو تعبير cron؟", answer: "تعبير cron هو سلسلة من 5 حقول تحدد جدولاً للمهام المتكررة. كل حقل: الدقيقة (0-59)، الساعة (0-23)، يوم الشهر (1-31)، الشهر (1-12)، يوم الأسبوع (0-7)." },
        { question: "ماذا يعني */5 * * * *؟", answer: "*/5 في حقل الدقائق يعني 'كل 5 دقائق'. التعبير الكامل: تشغيل كل 5 دقائق، كل ساعة، كل يوم. شائع لفحوصات الصحة." },
        { question: "ماذا يعني 0 9 * * 1-5؟", answer: "الساعة 09:00 صباحاً، من الاثنين إلى الجمعة. 1-5 في يوم الأسبوع يعني الاثنين (1) إلى الجمعة (5). شائع للتقارير اليومية." },
        { question: "هل يدعم اختصارات مثل @yearly؟", answer: "تركز هذه الأداة على صيغة 5 حقول الأكثر قابلية للنقل. الاختصارات مثل @daily خاصة بتطبيقات معينة. يمكنك التعبير عن نفس الجداول بـ 5 حقول: @daily = 0 0 * * *." },
        { question: "هل يُرسل تعبير cron إلى خادم؟", answer: "لا. كل التحليل يحدث في متصفحك. تعبيرات cron لا تغادر جهازك أبداً." },
      ],
    },
    sceneIntroTranslations: { es: "Encontraste una expresión cron en la configuración de un servidor: `0 2 * * 0`. ¿Se ejecuta a las 2 AM cada día, o solo los domingos? Podrías revisar la documentación. O pégala aquí y ve 'A las 02:00 AM, cada domingo' más las próximas 10 ejecuciones.", ar: "وجدت تعبير cron في إعدادات خادم: `0 2 * * 0`. هل يعمل الساعة 2 صباحاً كل يوم، أم فقط أيام الأحد؟ يمكنك مراجعة الوثائق. أو الصقه هنا وشاهد 'الساعة 02:00 صباحاً، كل أحد' بالإضافة إلى أوقات التنفيذ العشرة القادمة." },
  },
  {
    id: "text-sorter",
    name: "Text Sorter",
    description: "Sort lines of text alphabetically, by length, numerically, or randomly. Remove duplicates, ignore case, trim whitespace. Ideal for cleaning up lists, organizing data, and preparing ordered content.",
    category: "text",
    icon: "🔤",
    path: "/tools/text-sorter",
    seoTitle: "Free Text Sorter Online - Sort Lines Alphabetically & More 2026",
    seoDescription: "Sort text lines by A-Z, Z-A, length, random order, or reverse. Remove duplicates, ignore case, trim lines. Free online text sorter. No signup required.",
    seoKeywords: ["text sorter", "sort lines", "alphabetical sorter", "sort text online", "line sorter", "text organizer", "sort text alphabetically", "remove duplicates", "free text sorter"],
    relatedTools: ["remove-duplicate-lines", "word-counter", "case-converter"],
    sceneIntro: "You have a list of 200 email addresses, unsorted, with duplicates and trailing spaces. You need them alphabetized, deduped, and clean. Paste them here. Click A→Z, check Remove Duplicates and Trim Lines. Done in one click.",
    howToUse: ["Paste or type your text into the input area — one item per line.", "Choose a sort mode: A→Z, Z→A, By Length, Random, Reverse, or Numeric.", "Toggle options: Remove Duplicates, Ignore Case, Trim Lines.", "The sorted output appears instantly in the output panel.", "Copy the sorted text to your clipboard."],
    faq: [
      { question: "What does 'By Length' sort do?", answer: "By Length sorts lines from shortest to longest (ascending). The By Length ↓ option sorts from longest to shortest (descending). This is useful for finding the longest or shortest entries in a list, or for organizing content by verbosity." },
      { question: "How does Numeric sort work?", answer: "Numeric sort treats each line as a number and sorts by numeric value (1, 2, 10, 20) instead of alphabetical order (1, 10, 2, 20). Lines that are not valid numbers are placed at the end. This is useful for sorting version numbers, quantities, or any numeric data." },
      { question: "What does Randomize do?", answer: "Randomize shuffles the lines into a random order using the Fisher-Yates algorithm. Each click produces a different order. This is useful for randomizing quiz questions, creating randomized assignment lists, or picking a random winner from a list." },
      { question: "Is my text sent to any server?", answer: "No. All sorting and processing happens locally in your browser. Your text never leaves your device." },
      { question: "Can I sort CSV data with this tool?", answer: "You can sort CSV data line by line, but the tool treats each line as a single string — it doesn't parse CSV columns. For sorting by a specific CSV column, you'd need a spreadsheet tool. For simple line-by-line sorting of CSV data, this tool works fine." },
    ],
    nameTranslations: { es: "Ordenador de Texto", ar: "مصنف النصوص" },
    descriptionTranslations: { es: "Ordena líneas de texto alfabéticamente, por longitud, numéricamente o al azar. Elimina duplicados, ignora mayúsculas, recorta espacios. Ideal para limpiar listas.", ar: "صنف سطور النص أبجدياً أو حسب الطول أو رقمياً أو عشوائياً. أزل التكرارات، تجاهل حالة الأحرف، قلّم المسافات. مثالي لتنظيف القوائم." },
    seoTitleTranslations: { es: "Ordenador de Texto Gratis Online - Ordena Líneas Alfabéticamente 2026", ar: "مصنف نصوص مجاني عبر الإنترنت - صنف السطور أبجدياً 2026" },
    seoDescriptionTranslations: { es: "Ordena líneas de texto por A-Z, Z-A, longitud, orden aleatorio o inverso. Elimina duplicados, ignora mayúsculas, recorta líneas. Ordenador de texto online gratuito.", ar: "صنف سطور النص من أ-ي، ي-أ، حسب الطول، عشوائي، أو عكسي. أزل التكرارات، تجاهل حالة الأحرف، قلّم السطور. مصنف نصوص مجاني عبر الإنترنت." },
    howToUseTranslations: {
      es: ["Pega o escribe tu texto en el área de entrada — un elemento por línea.", "Elige un modo: A→Z, Z→A, Por Longitud, Aleatorio, Inverso, o Numérico.", "Activa opciones: Eliminar Duplicados, Ignorar Mayúsculas, Recortar Líneas.", "El resultado aparece instantáneamente en el panel de salida.", "Copia el texto ordenado a tu portapapeles."],
      ar: ["الصق أو اكتب نصك في منطقة الإدخال — عنصر واحد لكل سطر.", "اختر وضعاً: أ→ي، ي→أ، حسب الطول، عشوائي، عكسي، أو رقمي.", "فعّل الخيارات: إزالة التكرارات، تجاهل حالة الأحرف، تقليم السطور.", "تظهر النتيجة فوراً في لوحة الإخراج.", "انسخ النص المرتب إلى الحافظة."],
    },
    faqTranslations: {
      es: [
        { question: "¿Qué hace el orden 'Por Longitud'?", answer: "Ordena líneas de más corta a más larga (ascendente). La opción ↓ ordena de más larga a más corta. Útil para encontrar las entradas más largas o cortas en una lista." },
        { question: "¿Cómo funciona el orden Numérico?", answer: "Trata cada línea como número y ordena por valor numérico (1, 2, 10, 20) en lugar de alfabético (1, 10, 2, 20). Líneas no numéricas van al final." },
        { question: "¿Qué hace Aleatorizar?", answer: "Mezcla las líneas en orden aleatorio usando el algoritmo Fisher-Yates. Cada clic produce un orden diferente. Útil para preguntas de examen al azar o elegir un ganador." },
        { question: "¿Mi texto se envía a algún servidor?", answer: "No. Todo el procesamiento ocurre en tu navegador. Tu texto nunca sale de tu dispositivo." },
        { question: "¿Puedo ordenar datos CSV?", answer: "Puedes ordenar CSV línea por línea, pero la herramienta trata cada línea como una sola cadena. Para ordenar por columna específica necesitarías una hoja de cálculo." },
      ],
      ar: [
        { question: "ماذا يفعل ترتيب 'حسب الطول'؟", answer: "يرتب السطور من الأقصر إلى الأطول (تصاعدي). الخيار ↓ يرتب من الأطول إلى الأقصر. مفيد لإيجاد أطول أو أقصر الإدخالات." },
        { question: "كيف يعمل الترتيب الرقمي؟", answer: "يعامل كل سطر كرقم ويرتب حسب القيمة الرقمية (1، 2، 10، 20) بدلاً من الترتيب الأبجدي (1، 10، 2، 20). السطور غير الرقمية تذهب للنهاية." },
        { question: "ماذا يفعل العشوائي؟", answer: "يخلط السطور بترتيب عشوائي باستخدام خوارزمية Fisher-Yates. كل نقرة تنتج ترتيباً مختلفاً. مفيد لأسئلة الاختبارات العشوائية." },
        { question: "هل يُرسل نصي إلى أي خادم؟", answer: "لا. كل المعالجة تتم محلياً في متصفحك. نصك لا يغادر جهازك أبداً." },
        { question: "هل يمكنني ترتيب بيانات CSV؟", answer: "يمكنك ترتيب CSV سطراً بسطر، لكن الأداة تعامل كل سطر كسلسلة واحدة. للترتيب حسب عمود محدد تحتاج لبرنامج جداول." },
      ],
    },
    sceneIntroTranslations: { es: "Tienes una lista de 200 correos electrónicos, desordenada, con duplicados y espacios. Necesitas orden alfabético, sin duplicados, limpia. Pégala aquí. Haz clic en A→Z, marca Eliminar Duplicados y Recortar Líneas. Listo.", ar: "لديك قائمة بـ 200 بريد إلكتروني، غير مرتبة، مع تكرارات ومسافات. تحتاجها مرتبة أبجدياً، بدون تكرارات، نظيفة. الصقها هنا. انقر أ→ي، فعّل إزالة التكرارات وتقليم السطور. تم." },
  },
