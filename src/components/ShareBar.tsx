...
export default function ShareBar({ locale = "en", dict }: ShareBarProps) {
  const [copied, setCopied] = useState(false);
  const t = ((dict as any)?.shareBar) || {};
  const label = t.share || "Share this tool";
  const copiedLabel = { en: "Copied!", es: "¡Copiado!", ar: "تم النسخ!" }[locale] || "Copied!";
  ...
  const shareLinks = [
    ...
    },
    {
      id: "facebook",
      label: "Facebook",
      title: t.facebook || "Share on Facebook",
    ...
    },
    {
      id: "reddit",
      label: "Reddit",
      title: t.reddit || "Share on Reddit",
      href: `https://www.reddit.com/submit?url=${encodeURIComponent(url)}&title=${encodeURIComponent(title)}`,
      icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0zm5.01 4.744c.688 0 1.25.561 1.25 1.249a1.25 1.25 0 0 1-2.498.056l-2.597-.547-.8 3.747c1.824.07 3.48.632 4.674 1.488.308-.309.73-.491 1.207-.491.968 0 1.754.786 1.754 1.754 0 .716-.435 1.333-1.01 1.614a3.111 3.111 0 0 1 .042.52c0 2.694-3.13 4.87-7.004 4.87-3.874 0-7.004-2.176-7.004-4.87 0-.183.015-.366.043-.534A1.748 1.748 0 0 1 4.028 12c0-.968.786-1.754 1.754-1.754.463 0 .898.196 1.207.47 1.207-.883 2.878-1.43 4.744-1.487l.885-4.182a.342.342 0 0 1 .14-.197.35.35 0 0 1 .238-.042l2.906.617a1.214 1.214 0 0 1 1.108-.681zM9.25 12C8.56 12 8 12.56 8 13.25s.56 1.25 1.25 1.25 1.25-.56 1.25-1.25S9.94 12 9.25 12zm5.5 0c-.69 0-1.25.56-1.25 1.25s.56 1.25 1.25 1.25 1.25-.56 1.25-1.25-.56-1.25-1.25-1.25zm-3.73 4.16c.256.315.801.706 1.73.706.93 0 1.45-.391 1.73-.706a.5.5 0 0 0-.76-.652c-.14.188-.468.358-.97.358s-.83-.17-.97-.358a.5.5 0 0 0-.76.652z"/></svg>,
    },
    {
      id: "linkedin",
      label: "LinkedIn",
      title: t.linkedin || "Share on LinkedIn",
    ...
    },
    {
      id: "whatsapp",
      label: "WhatsApp",
      title: t.whatsapp || "Share on WhatsApp",
    ...
    },
    {
      id: "telegram",
      label: "Telegram",
      title: t.telegram || "Share on Telegram",
    ...
    {
      id: "copy",
      label: copied ? copiedLabel : (t.copy || "Copy Link"),
      title: t.copyTitle || "Copy link",
      href: "#",
      icon: copied
