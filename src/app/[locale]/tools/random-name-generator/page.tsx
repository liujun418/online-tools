...
import RandomNameGeneratorClient from "@/app/tools/random-name-generator/RandomNameGeneratorClient";
...
const TOOL_ID = "random-name-generator";
...
export default async function ToolPage({
  ...
  return <RandomNameGeneratorClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
