...
import SvgMinifierClient from "@/app/tools/svg-minifier/SvgMinifierClient";
...
export default async function ToolPage({
  ...
  return <SvgMinifierClient locale={locale as Locale} dict={dict} titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
