...
import CssMinifierClient from "@/app/tools/css-minifier/CssMinifierClient";
...
export default async function ToolPage({
  ...
  return <CssMinifierClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
