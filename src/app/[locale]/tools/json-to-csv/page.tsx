...
import JsonToCsvClient from "@/app/tools/json-to-csv/JsonToCsvClient";
...
export default async function ToolPage({
  ...
  return <JsonToCsvClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
