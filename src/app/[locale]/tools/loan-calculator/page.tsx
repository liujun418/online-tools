...
import LoanCalculatorClient from "@/app/tools/loan-calculator/LoanCalculatorClient";
...
export default async function ToolPage({
  ...
  return <LoanCalculatorClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
