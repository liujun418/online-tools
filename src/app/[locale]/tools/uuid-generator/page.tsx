...
import UuidGeneratorClient from "@/app/tools/uuid-generator/UuidGeneratorClient";
...
export default async function ToolPage({
  ...
  return <UuidGeneratorClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
