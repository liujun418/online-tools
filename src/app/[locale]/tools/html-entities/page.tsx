...
import HtmlEntitiesClient from "@/app/tools/html-entities/HtmlEntitiesClient";
...
export default async function ToolPage({
  ...
  return <HtmlEntitiesClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
