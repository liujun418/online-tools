...
import FoodPickerClient from "@/app/tools/food-picker/FoodPickerClient";
...
export default async function ToolPage({
  ...
  return <FoodPickerClient locale={locale as Locale} dict={dict} titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
