...
import QuotesClient from "@/app/tools/quotes/QuotesClient";
...
export default async function ToolPage({
  ...
  return <QuotesClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
