...
import MarkdownPreviewClient from "@/app/tools/markdown-preview/MarkdownPreviewClient";
...
export default async function ToolPage({
  ...
  return <MarkdownPreviewClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
