...
import ReactionTestClient from "@/app/tools/reaction-test/ReactionTestClient";
...
export default async function ToolPage({
  ...
  return <ReactionTestClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
