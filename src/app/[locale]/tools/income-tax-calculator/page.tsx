...
import IncomeTaxCalculatorClient from "@/app/tools/income-tax-calculator/IncomeTaxCalculatorClient";
...
const TOOL_ID = "income-tax-calculator";
...
export default async function ToolPage({
  ...
  return <IncomeTaxCalculatorClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
