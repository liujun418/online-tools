...
import DiscountCalculatorClient from "@/app/tools/discount-calculator/DiscountCalculatorClient";
...
export default async function ToolPage({
  ...
  return <DiscountCalculatorClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
