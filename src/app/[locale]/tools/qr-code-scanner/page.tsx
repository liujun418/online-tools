...
import QrCodeScannerClient from "@/app/tools/qr-code-scanner/QrCodeScannerClient";
...
export default async function ToolPage({
  ...
  return <QrCodeScannerClient locale={locale as Locale} dict={dict} titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
