...
import GifSearchClient from "@/app/tools/gif-search/GifSearchClient";
...
export default async function ToolPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return <GifSearchClient locale={locale as Locale} dict={dict} titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
