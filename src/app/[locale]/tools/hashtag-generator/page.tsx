...
import HashtagGeneratorClient from "@/app/tools/hashtag-generator/HashtagGeneratorClient";
...
const TOOL_ID = "hashtag-generator";
...
export default async function ToolPage({
  ...
  return <HashtagGeneratorClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
