...
import AgeCalculatorClient from "@/app/tools/age-calculator/AgeCalculatorClient";
...
export default async function ToolPage({
  ...
  return <AgeCalculatorClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
