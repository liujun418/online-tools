...
import CronParserClient from "@/app/tools/cron-parser/CronParserClient";
...
export default async function ToolPage({
  ...
  return <CronParserClient locale={locale as Locale} dict={dict} titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}