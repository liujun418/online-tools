...
import WordCounterClient from "@/app/tools/word-counter/WordCounterClient";
...
export default async function ToolPage({
  ...
  return <WordCounterClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
