...
import ColorContrastCheckerClient from "@/app/tools/color-contrast-checker/ColorContrastCheckerClient";
...
export default async function ToolPage({
  ...
  return <ColorContrastCheckerClient locale={locale as Locale} dict={dict} titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
