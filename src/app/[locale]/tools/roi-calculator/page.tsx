...
import RoiCalculatorClient from "@/app/tools/roi-calculator/RoiCalculatorClient";
...
export default async function ToolPage({
  ...
  return <RoiCalculatorClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
