...
import JSONFormatterClient from "@/app/tools/json-formatter/JSONFormatterClient";
...
export default async function ToolPage({
  ...
  return <JSONFormatterClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
