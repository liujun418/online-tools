...
import PregnancyCalculatorClient from "@/app/tools/pregnancy-calculator/PregnancyCalculatorClient";
...
const TOOL_ID = "pregnancy-calculator";
...
export default async function ToolPage({
  ...
  return <PregnancyCalculatorClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
