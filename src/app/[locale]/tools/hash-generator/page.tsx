...
import HashGeneratorClient from "@/app/tools/hash-generator/HashGeneratorClient";
...
export default async function ToolPage({
  ...
  return <HashGeneratorClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
