...
import PasswordGeneratorClient from "@/app/tools/password-generator/PasswordGeneratorClient";
...
export default async function ToolPage({
  ...
  return <PasswordGeneratorClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
