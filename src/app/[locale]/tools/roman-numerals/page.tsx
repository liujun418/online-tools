...
import RomanNumeralsClient from "@/app/tools/roman-numerals/RomanNumeralsClient";
...
export default async function ToolPage({
  ...
  return <RomanNumeralsClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
