...
import QRCodeGeneratorClient from "@/app/tools/qr-code-generator/QRCodeGeneratorClient";
...
export default async function ToolPage({
  ...
  return <QRCodeGeneratorClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
