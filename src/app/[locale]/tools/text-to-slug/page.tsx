...
import TextToSlugClient from "@/app/tools/text-to-slug/TextToSlugClient";
...
export default async function ToolPage({
  ...
  return <TextToSlugClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
