...
import CompoundInterestClient from "@/app/tools/compound-interest/CompoundInterestClient";
...
export default async function ToolPage({
  ...
  return <CompoundInterestClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
