...
import TipCalculatorClient from "@/app/tools/tip-calculator/TipCalculatorClient";
...
export default async function ToolPage({
  ...
  return <TipCalculatorClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
