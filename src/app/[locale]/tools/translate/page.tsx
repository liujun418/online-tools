...
import TranslateClient from "@/app/tools/translate/TranslateClient";
...
export default async function ToolPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return <TranslateClient locale={locale as Locale} dict={dict} titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
