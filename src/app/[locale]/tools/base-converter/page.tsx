...
import BaseConverterClient from "@/app/tools/base-converter/BaseConverterClient";
...
export default async function ToolPage({
  ...
  return <BaseConverterClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
