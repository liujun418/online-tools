...
import JwtDecoderClient from "@/app/tools/jwt-decoder/JwtDecoderClient";
...
export default async function ToolPage({
  ...
  return <JwtDecoderClient locale={locale as Locale} dict={dict} titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}