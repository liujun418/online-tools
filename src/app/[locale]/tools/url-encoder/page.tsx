...
import UrlEncoderClient from "@/app/tools/url-encoder/UrlEncoderClient";
...
export default async function ToolPage({
  ...
  return <UrlEncoderClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
