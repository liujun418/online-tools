...
import UnixTimestampClient from "@/app/tools/unix-timestamp/UnixTimestampClient";
...
export default async function ToolPage({
  ...
  return <UnixTimestampClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
