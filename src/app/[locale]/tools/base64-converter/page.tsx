...
import Base64ConverterClient from "@/app/tools/base64-converter/Base64ConverterClient";
...
export default async function ToolPage({
  ...
  return <Base64ConverterClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
