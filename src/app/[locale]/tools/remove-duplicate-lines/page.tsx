...
import RemoveDuplicateLinesClient from "@/app/tools/remove-duplicate-lines/RemoveDuplicateLinesClient";
...
export default async function ToolPage({
  ...
  return <RemoveDuplicateLinesClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
