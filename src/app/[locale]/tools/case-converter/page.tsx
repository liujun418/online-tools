...
import CaseConverterClient from "@/app/tools/case-converter/CaseConverterClient";
...
export default async function ToolPage({
  ...
  return <CaseConverterClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
