...
import AIToolsClient from "@/app/tools/ai-tools/AIToolsClient";
...
export default async function ToolPage({
  ...
  return <AIToolsClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
