...
import LateralThinkingClient from "@/app/tools/lateral-thinking/LateralThinkingClient";
...
const TOOL_ID = "lateral-thinking";
...
export default async function ToolPage({
  ...
  return (
    <LateralThinkingClient
      locale={locale as Locale}
      dict={dict}
      titleOverride={toolTitle}
