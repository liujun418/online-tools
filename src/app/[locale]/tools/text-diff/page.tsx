...
import TextDiffClient from "@/app/tools/text-diff/TextDiffClient";
...
export default async function ToolPage({
  ...
  return <TextDiffClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
