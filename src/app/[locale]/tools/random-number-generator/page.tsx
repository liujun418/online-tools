...
import RandomNumberClient from "@/app/tools/random-number-generator/RandomNumberClient";
...
const TOOL_ID = "random-number-generator";
...
export default async function ToolPage({
  ...
  return <RandomNumberClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
