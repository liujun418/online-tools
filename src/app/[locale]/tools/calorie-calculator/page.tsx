...
import CalorieCalculatorClient from "@/app/tools/calorie-calculator/CalorieCalculatorClient";
...
const TOOL_ID = "calorie-calculator";
...
export default async function ToolPage({
  ...
  return <CalorieCalculatorClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
