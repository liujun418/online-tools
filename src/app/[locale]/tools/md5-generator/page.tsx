...
import MD5GeneratorClient from "@/app/tools/md5-generator/MD5GeneratorClient";
...
export default async function ToolPage({
  ...
  return <MD5GeneratorClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
