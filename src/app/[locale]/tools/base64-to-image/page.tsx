...
import Base64ToImageClient from "@/app/tools/base64-to-image/Base64ToImageClient";
...
export default async function ToolPage({
  ...
  return <Base64ToImageClient locale={locale as Locale} dict={dict} titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
