...
import CsvToJsonClient from "@/app/tools/csv-to-json/CsvToJsonClient";
...
export default async function ToolPage({
  ...
  return <CsvToJsonClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
