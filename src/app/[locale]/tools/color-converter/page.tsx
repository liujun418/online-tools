...
import ColorConverterClient from "@/app/tools/color-converter/ColorConverterClient";
...
export default async function ToolPage({
  ...
  return <ColorConverterClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
