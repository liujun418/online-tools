...
import PerpetualCalendarClient from "@/app/tools/perpetual-calendar/PerpetualCalendarClient";
...
const TOOL_ID = "perpetual-calendar";
...
export default async function ToolPage({
  ...
  return <PerpetualCalendarClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
