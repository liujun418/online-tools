...
import BMICalculatorClient from "@/app/tools/bmi-calculator/BMICalculatorClient";
...
export default async function ToolPage({
  ...
  return <BMICalculatorClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
