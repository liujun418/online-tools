...
import TextSorterClient from "@/app/tools/text-sorter/TextSorterClient";
...
export default async function ToolPage({
  ...
  return <TextSorterClient locale={locale as Locale} dict={dict} titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}