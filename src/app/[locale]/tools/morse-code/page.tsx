...
import MorseCodeClient from "@/app/tools/morse-code/MorseCodeClient";
...
export default async function ToolPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return <MorseCodeClient locale={locale as Locale} dict={dict} titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
