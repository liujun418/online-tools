...
import ImageToBase64Client from "@/app/tools/image-to-base64/ImageToBase64Client";
...
export default async function ToolPage({
  ...
  return <ImageToBase64Client locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
