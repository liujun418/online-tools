...
import BookOfAnswersClient from "@/app/tools/book-of-answers/BookOfAnswersClient";
...
export default async function ToolPage({
  ...
  return <BookOfAnswersClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
