...
import TextRepeaterClient from "@/app/tools/text-repeater/TextRepeaterClient";
...
export default async function ToolPage({
  ...
  return <TextRepeaterClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
