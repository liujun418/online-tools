...
import FancyTextGeneratorClient from "@/app/tools/fancy-text-generator/FancyTextGeneratorClient";
...
const TOOL_ID = "fancy-text-generator";
...
export default async function ToolPage({
  ...
  return <FancyTextGeneratorClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
