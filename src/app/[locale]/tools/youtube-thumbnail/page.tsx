...
import YouTubeThumbnailClient from "@/app/tools/youtube-thumbnail/YouTubeThumbnailClient";
...
const TOOL_ID = "youtube-thumbnail";
...
export default async function ToolPage({
  ...
  return <YouTubeThumbnailClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
