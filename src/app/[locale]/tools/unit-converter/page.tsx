...
import UnitConverterClient from "@/app/tools/unit-converter/UnitConverterClient";
...
export default async function ToolPage({
  ...
  return <UnitConverterClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
