...
import LoremIpsumClient from "@/app/tools/lorem-ipsum/LoremIpsumClient";
...
export default async function ToolPage({
  ...
  return <LoremIpsumClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
