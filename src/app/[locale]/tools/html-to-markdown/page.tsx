...
import HtmlToMarkdownClient from "@/app/tools/html-to-markdown/HtmlToMarkdownClient";
...
export default async function ToolPage({
  ...
  return <HtmlToMarkdownClient locale={locale as Locale} dict={dict} titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
