...
import MortgageCalculatorClient from "@/app/tools/mortgage-calculator/MortgageCalculatorClient";
...
const TOOL_ID = "mortgage-calculator";
...
export default async function ToolPage({
  ...
  return <MortgageCalculatorClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
