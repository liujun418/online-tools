...
import RegexTesterClient from "@/app/tools/regex-tester/RegexTesterClient";
...
export default async function ToolPage({
  ...
  return <RegexTesterClient locale={locale as Locale} dict={dict}  titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
