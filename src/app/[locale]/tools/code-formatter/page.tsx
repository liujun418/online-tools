...
import CodeFormatterClient from "@/app/tools/code-formatter/CodeFormatterClient";
...
export default async function ToolPage({
  ...
  return <CodeFormatterClient locale={locale as Locale} dict={dict} titleOverride={toolTitle} descriptionOverride={toolDescription} />;
}
